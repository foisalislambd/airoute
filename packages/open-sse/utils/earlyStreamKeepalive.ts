...
export const OPENAI_KEEPALIVE_FRAME = ENCODER.encode(
  'data: {"id":"airoute-keepalive","object":"chat.completion.chunk","created":0,"model":"airoute","choices":[{"index":0,"delta":{},"finish_reason":null}]}\n\n'
);
...
const RESPONSES_STARTUP_ITEM_ID = "rs_airoute_keepalive";
const STARTUP_THINKING_TEXT = "AIRoute: got request, sending to provider";
