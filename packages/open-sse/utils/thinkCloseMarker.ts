 ...
 *   - Explicit opt-in: `x-airoute-thinking-marker: on` force-keeps it for the
 *     shrinking set of content-scanning clients (#4633).
 *   - Explicit opt-out: `x-airoute-thinking-marker: off` (same as default).
 ...
 *   2. Explicit `x-airoute-thinking-marker` header → honor on/off (#5312)
...
export function resolveSuppressThinkClose(opts: {
  ...
  // Legacy content-scanning clients opt in with x-airoute-thinking-marker: on.
  return true;
}
