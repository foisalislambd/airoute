...
import { skillRegistry } from "../../core/lib/skills/registry.ts";
import { skillExecutor } from "../../core/lib/skills/executor.ts";
...
import { getDbInstance } from "../../core/lib/db/core.ts";
import { normalizeQuotaResponse } from "../../core/shared/contracts/quota.ts";
import { resolveAIRouteBaseUrl } from "../../core/shared/utils/resolveAIRouteBaseUrl.ts";
...
async function handleRouteRequest(args: {
  ...
  try {
    const body: Record<string, unknown> = {
      // Combos are selected by model name via getComboForModel — body["x-combo"]
      // is ignored. When the tool passes `combo`, use it as the request model.
      model: args.combo || args.model,
