...
} from "../../../core/shared/constants/routingStrategies.ts";
import { normalizeRoutingStrategy } from "../../../core/shared/constants/routingStrategies.ts";
...
export async function handleDbHealthCheck(args: { autoRepair?: boolean }) {
  ...
  try {
    const { runManagedDbHealthCheck } = await import("../../../core/lib/db/core.ts");
