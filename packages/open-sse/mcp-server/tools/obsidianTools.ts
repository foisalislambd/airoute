import { z } from "zod";
import { createObsidianClient, createSyncServerClient, getSyncToken } from "../../../core/lib/obsidian/api.ts";
import {
  getObsidianToken,
  getObsidianBaseUrl,
  getObsidianConfigForApiKey,
} from "../../../core/lib/db/obsidian.ts";
import type { ObsidianClient, SyncServerClient } from "../../../core/lib/obsidian/api.ts";
