...
export const gamificationTools = [
  {
    ...
    handler: async (args: { scope: string; limit: number }) => {
      const { getTopN } = await import("../../../core/lib/gamification/leaderboard");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string; scope: string }) => {
      const { getRank } = await import("../../../core/lib/gamification/leaderboard");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string }) => {
      const { getXp, getBadges } = await import("../../../core/lib/db/gamification");
      const { calculateLevel, getLevelTitle, getLevelTier } =
        await import("../../../core/lib/gamification/xp");
      const { getStreak } = await import("../../../core/lib/gamification/streaks");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId?: string; category?: string }) => {
      const { getBadgeDefinitions, getBadges } = await import("../../../core/lib/db/gamification");
  ...
  },
  {
    ...
    handler: async (args: {
      ...
      const { transferTokens } = await import("../../../core/lib/gamification/sharing");
  ...
  },
  {
    ...
    handler: async (args: { apiKeyId: string; serverUrl?: string; maxUses: number }) => {
      const { createInvite } = await import("../../../core/lib/gamification/invites");
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { listServers } = await import("../../../core/lib/gamification/servers");
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { getAnomalies } = await import("../../../core/lib/gamification/antiCheat");
