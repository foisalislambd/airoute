...
import { extractApiKey, isValidApiKey } from "../../core/sse/services/auth.ts";
 ...
 * per-key scopes instead of falling back to the `AIROUTE_MCP_SCOPES` env var.
 */
