...
/**
 * Map AIRoute's reasoning-effort inputs onto the binary thinking switch exposed by
...
// AIRoute carries the requested effort on up to three shapes:
//   1. top-level `reasoning_effort`        — OpenAI / AIRoute-internal
