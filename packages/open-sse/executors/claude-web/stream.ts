...
function responseHeaders(contentType: string, metadata: Record<string, string>): Headers {
  ...
  const headerNames: Record<string, string> = {
    operation: "X-AIRoute-Claude-Web-Operation",
    conversation_id: "X-AIRoute-Claude-Web-Conversation-Id",
    parent_message_uuid: "X-AIRoute-Claude-Web-Parent-Message-Uuid",
    assistant_message_uuid: "X-AIRoute-Claude-Web-Assistant-Message-Uuid",
  };
