 ...
 * (Anthropic's current model migration guidance). AIRoute can still produce a manual
 ...
 * This contract is verified for AIRoute's two direct Anthropic API providers:
