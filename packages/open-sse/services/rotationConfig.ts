 ...
 *
 * AIRoute's account-fallback engine (accountFallback.ts) historically rotated accounts using
 ...
 *   - master enable                            AIROUTE_ROTATION_ENABLED               (default true)
 *   - rate-limit reset/cooldown seconds        AIROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS (0 => engine default)
 *   - per-status fallback enable               AIROUTE_ROTATE_ON_{429,500,502,400}    (429/500/502 default true, 400 default false)
 *   - per-status threshold (errors in window)  AIROUTE_ROTATE_{status}_THRESHOLD      (default 1 => immediate, current behavior)
 *   - per-status window seconds                AIROUTE_ROTATE_{status}_WINDOW_SECONDS (default 120)
 *
...
const GLOBAL_KEY = "__airoute_rotation_config__";
...
function buildFromEnv(): RotationConfig {
  return {
    enabled: envBool("AIROUTE_ROTATION_ENABLED", true),
    rateLimitResetMs: envInt("AIROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS", 0, 0) * 1000,
    disableTagWithoutReset: envBool("AIROUTE_ROTATION_DISABLE_TAG_WITHOUT_RESET", true),
    rateLimit429: buildClass(
      "AIROUTE_ROTATE_ON_429",
      "AIROUTE_ROTATE_429_THRESHOLD",
      "AIROUTE_ROTATE_429_WINDOW_SECONDS",
      true
    ),
    serverError500: buildClass(
      "AIROUTE_ROTATE_ON_500",
      "AIROUTE_ROTATE_500_THRESHOLD",
      "AIROUTE_ROTATE_500_WINDOW_SECONDS",
      true
    ),
    badGateway502: buildClass(
      "AIROUTE_ROTATE_ON_502",
      "AIROUTE_ROTATE_502_THRESHOLD",
      "AIROUTE_ROTATE_502_WINDOW_SECONDS",
      true
    ),
    badRequest400: buildClass(
      "AIROUTE_ROTATE_ON_400",
      "AIROUTE_ROTATE_400_THRESHOLD",
      "AIROUTE_ROTATE_400_WINDOW_SECONDS",
      false
    ),
  };
}
...
const COUNTER_KEY = "__airoute_rotation_counters__";
