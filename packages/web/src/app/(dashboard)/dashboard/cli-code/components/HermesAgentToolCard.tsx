        ...
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            {HERMES_ROLES.map((role) => {
              ...
              let badge: { label: string; pending: boolean; outsideAIRoute: boolean } | null =
                null;
              ...
              if (sel) {
                ...
                badge = {
                  label: t("hermesViaAIRoute", { provider: prov }),
                  pending: true,
                  outsideAIRoute: false,
                };
              } else if (current) {
                const isOmni =
                ...
                if (isOmni) {
                  badge = { label: "AIRoute", pending: false, outsideAIRoute: false };
                } else {
                  const realProvider = current.provider || t("other");
                  badge = {
                    label: t("hermesNotAIRoute", { provider: realProvider }),
                    pending: false,
                    outsideAIRoute: true,
                  };
                }
