...
declare global {
  ...
  var __airouteDbProbeRestoreCount: number | undefined;
  ...
  var __airouteDbOomFailureCount: number | undefined;
}
...
export function getDbInstance(): SqliteDatabase {
  ...
  if (!fs.existsSync(sqliteFile) && probeFailureBackups.length > 0) {
    ...
    if (
      (globalThis.__airouteDbProbeRestoreCount =
        (globalThis.__airouteDbProbeRestoreCount || 0) + 1) > 3
    ) {
      throw new Error(
  ...
  if (fs.existsSync(sqliteFile)) {
    try {
      ...
      if (
        ...
        if (
          (globalThis.__airouteDbOomFailureCount =
            (globalThis.__airouteDbOomFailureCount || 0) + 1) > 3
        ) {
          throw new Error(
