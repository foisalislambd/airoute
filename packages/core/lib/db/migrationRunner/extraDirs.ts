 ...
 * space: `NNN_name.sql` is recorded in `_airoute_migrations` as `NNN`. That
 ...
 * namespace:
 *
 *   AIROUTE_EXTRA_MIGRATIONS_DIRS="ee=/opt/app/enterprise/db/migrations"
 *
...
export const EXTRA_MIGRATIONS_DIRS_ENV = "AIROUTE_EXTRA_MIGRATIONS_DIRS";
