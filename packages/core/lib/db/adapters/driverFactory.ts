...
declare global {
  ...
  var __airouteSqlJsInitPromises: Map<string, Promise<SqliteAdapter>> | undefined;
  var __airouteSqlJsPreInitErrors: Map<string, string> | undefined;
}
...
function getSqlJsPreInitErrorCache(): Map<string, string> {
  if (!globalThis.__airouteSqlJsPreInitErrors) {
    globalThis.__airouteSqlJsPreInitErrors = new Map();
  }
  return globalThis.__airouteSqlJsPreInitErrors;
}
...
function getSqlJsPendingCache(): Map<string, Promise<SqliteAdapter>> {
  if (!globalThis.__airouteSqlJsInitPromises) {
    globalThis.__airouteSqlJsInitPromises = new Map();
  }
  return globalThis.__airouteSqlJsInitPromises;
}
