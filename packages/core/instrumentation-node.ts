...
export async function registerNodejs(): Promise<void> {
  ...
  // AIROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK and its cadence is tunable via
  ...
  if (!isBackgroundServicesDisabled()) {
    ...
    await Promise.allSettled([
      ...
      // Reads the schedule written by `airoute backup auto enable` and fires
      ...
      // flag-gated auto-start (AIROUTE_ENABLE_LIVE_WS, default ON).
