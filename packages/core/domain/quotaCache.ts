...
declare global {
  var __airouteQuotaCacheState: QuotaCacheState | undefined;
}

function getState(): QuotaCacheState {
  if (!globalThis.__airouteQuotaCacheState) {
    globalThis.__airouteQuotaCacheState = {
      cache: new Map(),
  ...
  return globalThis.__airouteQuotaCacheState;
}
