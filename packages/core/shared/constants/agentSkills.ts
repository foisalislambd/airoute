...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
  ...
  },
  {
    ...
    description:
      "Detect installed CLI coding tools (Claude Code, Codex, Cursor, Copilot, Cline and more), search GitHub for matching agent skills, and install them to the detected tools via AIRoute's built-in APIs.",
    category: "cli",
    area: "cli-setup",
    icon: "extension",
  },
