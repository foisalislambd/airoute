...
| [why-pain-fix.svg](./why-pain-fix.svg)                 | README.md (root) | Animated "Why AIRoute" 10-row pain-vs-fix ledger (15s green row sweep). Edit the SVG directly — there is no `.mmd` source.                                                                                              |
