...
Antigravity requests preserve caller text byte-for-byte. AIRoute does not insert zero-width characters into prompts or rename/inject tools to imitate an IDE client.
