...
- **Tracking issue:** [#8075](https://github.com/diegosouzapw/AIRoute/issues/8075)
- **Scope:** Persistence architecture only; this decision does not add or select an external database

## Context

AIRoute currently presents domain-oriented persistence functions from `src/lib/db/`, while the
