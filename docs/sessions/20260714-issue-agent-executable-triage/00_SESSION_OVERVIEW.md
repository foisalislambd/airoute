...
must execute recorded GitHub triage through AIRoute routing, persist a complete
...
| DEC-002     | Keep issue-agent execution opt-in with `AIROUTE_ISSUE_AGENT_ENABLED=true`      | prevents unrequested autonomous execution                                                                      | `implemented` |
