...
async function runConfigListCommand(opts = {}) {
  const { detectAllTools } = await import("../../../packages/core/lib/cli-helper/tool-detector.ts");
...
async function runConfigGetCommand(toolId, opts = {}) {
  ...
  const { detectTool } = await import("../../../packages/core/lib/cli-helper/tool-detector.ts");
...
async function runConfigSetCommand(toolId, opts = {}) {
  ...
  const { generateConfig } = await import("../../../packages/core/lib/cli-helper/config-generator/index.js");
