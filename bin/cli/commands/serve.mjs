...
export async function runServe(opts = {}) {
  ...
  // Same prep as bin/airoute.mjs — keep it here so a direct `runServe()` call
    ...
    onCrashCallback: async (crashLog) => {
      if (detectMitmCrash(crashLog)) {
        try {
          ...
          const { updateSettings } = await import(`${PROJECT_ROOT}/packages/core/lib/db/settings.ts`);
