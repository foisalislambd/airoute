 ...
 * (packages/core/server/authz/policies/management.ts → resolveStampedPeer) trusts the IP
 ...
 * packages/core/server/authz/headers.ts (the TS side cannot import this .mjs).
 */
...
export function ensurePeerStampToken() {
  // Prefer AIROUTE_*; keep OMNIROUTE_* mirrored for any leftover readers.
  process.env.AIROUTE_PEER_STAMP_TOKEN ||=
    process.env.OMNIROUTE_PEER_STAMP_TOKEN || randomUUID();
  process.env.OMNIROUTE_PEER_STAMP_TOKEN = process.env.AIROUTE_PEER_STAMP_TOKEN;
