...
process.env.AIROUTE_INTERNAL_SCHEME = "http";
...
// webpack escape hatch (OMNIROUTE_USE_TURBOPACK kept as legacy alias).
const useTurbopack =
  dev && mergedEnv.AIROUTE_USE_TURBOPACK !== "0" && mergedEnv.OMNIROUTE_USE_TURBOPACK !== "0";
